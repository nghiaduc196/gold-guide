...
/**
 * Provides the default dashboard manager.
 */
class DashboardManager extends DefaultPluginManager {

  /**
   * Provides default values for all dashboard plugins.
   *
   * @var array
   */
  protected $defaults = [];
  ...
  public function __construct(ModuleHandlerInterface $module_handler, CacheBackendInterface $cache_backend) {
    ...
    $this->setCacheBackend($cache_backend, 'dashboard', ['dashboard']);
  }
  ...
  protected function getDiscovery() {
    if (!isset($this->discovery)) {
      $this->discovery = new YamlDiscovery('dashboard', $this->moduleHandler->getModuleDirectories());
